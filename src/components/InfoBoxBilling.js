...
export class InfoBoxBilling extends Component {
    constructor(props) {
        super(props);
...
const mapStateToProps = (state) => ({
    isOpenStates: state.newDDStatus.statesBill,
...
export default connect(mapStateToProps, mapDispatchToProps)(InfoBoxBilling)
